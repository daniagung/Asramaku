...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/css/icons/material-design-iconic-font/css/materialdesignicons.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-default navbar-static-top m-b-0">
        <div class="navbar-header">
            <div class="top-left-part">
                <!-- Logo -->
                <a class="logo" href="<?php base_url()?>">
    ...
    <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav slimscrollsidebar">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li> <a href="checkpoint" class="waves-effect"><i class="mdi mdi-table fa-fw"></i> <span class="hide-menu">Checkpoint<span class="fa arrow"></span></a>
                </li>
                <li> <a href="penghuni" class="waves-effect"><i class="mdi mdi-chart-bar fa-fw"></i> <span class="hide-menu">Penguni<span class="fa arrow"></span></span></a>
                </li>
            </ul>
        </div>
    </div>
