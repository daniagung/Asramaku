...
<section id="wrapper" class="login-register">
    <div class="login-box">
        <div class="white-box">
            <form class="form-horizontal form-material" id="loginform" action="checkpoint/check">
                ...
                <div class="form-group ">
                    <div class="col-xs-12">
                        <input class="form-control" type="text" required="" placeholder="Masukkan NIM Anda">
                        <br>

                        <div class="col-xs-6">
                            <div class="checkbox checkbox-info ">
                                <input id="checkbox-signup" type="checkbox">
                                <label for="checkbox-signup"> Masuk </label>
                            </div>
                        ...
                        <div class="col-xs-6">
                            <div class="checkbox checkbox-info ">
                                <input id="checkbox-signup" type="checkbox">
                                <label for="checkbox-signup"> Keluar </label>
                            </div>
...
<!--Style Switcher -->
<script src="<?php echo base_url();?>asset/plugins/bower_components/styleswitcher/jQuery.style.switcher.js"></script>
</body>
</html>
